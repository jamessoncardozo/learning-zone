...
<html lang="en">
    ...
    <body>
      ...
      <div class="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-gradient-to-r from-green-300 to-green-200">
        <div class="w-9/12 m-auto py-16 min-h-screen flex items-center justify-center mx-6">
          <div class="bg-white shadow overflow-hidden sm:rounded-lg pb-8 sm:mx-1">
            <div class="border-t border-gray-200 text-center px-8">
              <h1 class="text-9xl font-bold text-green-400">@yield('code')</h1>
              <h1 class="text-6xl font-medium py-8">@yield('title')</h1>
              <p class="text-2xl pb-8 px-12 font-medium">@yield('message')</p>
              <x-button class="cursor-pointer items-center justify-center block px-4 py-2 bg-green-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150" href="/">INÍCIO</x-jet-btn>
            </div>
          </div>
        </div>
