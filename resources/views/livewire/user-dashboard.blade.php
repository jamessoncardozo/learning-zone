  ...
  <div class="py-4">
    ...
    <div class="flex-col space-y-2 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="flex flex-wrap items-stretch md:flex-nowrap	px-2 md:p-2">
        ...
        <x-jet-button type="button" wire:click="exporting('xlsx')" wire:loading.attr="disabled" class="mb-1 md:m-1 mx-1 p-3 w-full md:w-1/6 bg-green-500 dark:bg-green-900 ring-green-800 text-center text-inline-flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 115.28 122.88" style="enable-background:new 0 0 115.28 122.88" xml:space="preserve" class=" fill-black dark:fill-white w-6 mr-2 -ml-1">
        ...
        <x-jet-button type="button" wire:click="sendUsers" wire:loading.attr="disabled" class="mb-1 md:m-1 mx-1 p-3 w-full md:w-1/6 bg-pink-500 dark:bg-pink-900 ring-pink-800 text-center inline-flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 371.13" class=" fill-black dark:fill-white w-6 mr-2 -ml-1">
            ...
            @forelse ($users as $user)
              ...
              <x-table.row class="transition-all hover:bg-gray-100 hover:shadow-lg">
                ...
                <x-table.cell>
                  ...
                  <x-jet-checkbox id="id" type="checkbox" class="form-checkbox h-5 w-5 text-green-600" wire:click="showName({{ $user->id }})" wire:model="selectedUsers.{{ $user->id }}" />  
