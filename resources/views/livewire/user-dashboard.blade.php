...
<div class="py-4">
  ...
  <div class="flex-col space-y-2 max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="flex flex-wrap items-stretch md:flex-nowrap	px-2 md:p-2">
      ...
      <div class="flex justify-center rounded-lg shadow-lg shadow-gray-900/50 mb-1 md:m-1 mx-1 p-3 w-full md:w-2/6">
        <x-input type="search"
          wire:debug wire:model.debounce.500ms="search"
      ...
      <div class="mb-1 md:m-1 mx-1 bg-green-500 dark:bg-green-900 ring-green-800 rounded-lg shadow-lg shadow-green-800 w-full md:w-1/6 flex justify-center">
      ...
      <div class="mb-1 md:m-1 mx-1 bg-lime-500 dark:bg-lime-900 ring-lime-800 rounded-lg shadow-lg shadow-lime-800 w-full md:w-1/6 flex justify-center">
        <x-button type="button"
            class="w-full bg-transparent"
            wire:debug wire:click="exporting('xls')"
            wire:loading.attr="disabled">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 115.28 122.88" style="enable-background:new 0 0 115.28 122.88" xml:space="preserve" class="fill-white w-6 mr-2 -ml-1">
            <style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style>
            <g>
      ...
      <div class="mb-1 md:m-1 mx-1 bg-indigo-500 dark:bg-indigo-900 ring-indigo-800 rounded-lg shadow-lg shadow-indigo-800 w-full md:w-1/6 flex justify-center">
        <x-button type="button"
          class="w-full bg-transparent"
          wire:debug wire:click="exporting('csv')" wire:loading.attr="disabled">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 115.28 122.88" style="enable-background:new 0 0 115.28 122.88" xml:space="preserve" class="fill-white w-6 mr-2 -ml-1">
            <style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style>
            <g>
      ...
      <div class="mb-1 md:m-1 mx-1 bg-red-500 dark:bg-red-900 ring-red-800 rounded-lg shadow-lg shadow-green-800 w-full md:w-1/6 flex justify-center">
        <x-button type="button"
          class="w-full bg-transparent"  
          wire:debug wire:click="exporting('PDF')" wire:loading.attr="disabled">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 115.28 122.88" style="enable-background:new 0 0 115.28 122.88" xml:space="preserve" class="fill-white w-6 mr-2 -ml-1">
            <style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style>
            <g>
      ...
      <div class="mb-1 md:m-1 mx-1 bg-pink-500 dark:bg-pink-900 ring-pink-800 rounded-lg shadow-lg shadow-pink-800 w-full md:w-1/6 flex justify-center">
        <x-button type="button"
          class="w-full bg-transparent"  
          wire:debug wire:click="sendUsers" wire:loading.attr="disabled">
      ...
      <div class="mb-1 md:m-1 mx-1 bg-amber-500 dark:bg-orange-900 ring-amber-800 rounded-lg shadow-lg shadow-amber-800 w-full md:w-1/6 flex justify-center">
          ...
          @forelse ($users as $user)
            ...
            <x-table.row class="transition-all hover:bg-gray-100 hover:shadow-lg">
              ...
              <x-table.cell>
                {{ var_dump($user->id)}}
                <div
                  class="transition ease-in-out delay-150 hover:animate-pulse rounded-lg p-1 bg-slate-500 w-full"
